...
SMODS.Edition({
    ...
    loc_txt = {name = "Lunar", label = "Lunar", text = {"{C:green}New Moon{} (Evo 0)", "{C:red}0.75x{} debuff to all cards"}}
})
SMODS.Edition({
...
SMODS.Edition({
    ...
    sound = {sound = 'generic1', per = 1, vol = 0.3},
    loc_txt = {name = "Lunar", label = "Lunar", text = {"{C:red}Waning Moon{} (Evo 0)", "{C:red}0.75x{} debuff to all cards"}}
})
...
SMODS.Edition({
    ...
    sound = {sound = 'generic1', per = 1, vol = 0.3},
    loc_txt = {name = "Lunar", label = "Lunar", text = {"{C:green}New Moon{} (Evo 1)", "{C:red}0.70x{} debuff", "{C:attention}Black{} cards immune"}}
})
SMODS.Edition({
...
SMODS.Edition({
    ...
    sound = {sound = 'generic1', per = 1, vol = 0.3},
    loc_txt = {name = "Lunar", label = "Lunar", text = {"{C:red}Waning Moon{} (Evo 1)", "{C:red}0.70x{} debuff", "{C:attention}Red{} cards immune"}}
})
...
SMODS.Edition({
    ...
    sound = {sound = 'generic1', per = 1, vol = 0.3},
    loc_txt = {name = "Lunar", label = "Lunar", text = {"{C:green}New Moon{} (Evo 2)", "{C:red}0.65x{} debuff", "{C:attention}Black{} cards {C:mult}+5{} Mult"}}
})
SMODS.Edition({
...
SMODS.Edition({
    ...
    sound = {sound = 'generic1', per = 1, vol = 0.3},
    loc_txt = {name = "Lunar", label = "Lunar", text = {"{C:red}Waning Moon{} (Evo 2)", "{C:red}0.65x{} debuff", "{C:attention}Red{} cards {C:mult}+5{} Mult"}}
})
...
SMODS.Edition({
    ...
    sound = {sound = 'generic1', per = 1, vol = 0.3},
    loc_txt = {name = "Lunar", label = "Lunar", text = {"{C:green}New Moon{} (Evo 3)", "{C:red}0.60x{} debuff", "{C:attention}Black{} cards {C:mult}+10{} Mult+Chips"}}
})
SMODS.Edition({
...
SMODS.Edition({
    ...
    sound = {sound = 'generic1', per = 1, vol = 0.3},
    loc_txt = {name = "Lunar", label = "Lunar", text = {"{C:red}Waning Moon{} (Evo 3)", "{C:red}0.60x{} debuff", "{C:attention}Red{} cards {C:mult}+10{} Mult+Chips"}}
})
...
SMODS.Edition({
    key = 'odyssey_lunar_green', shader = 'lunar_green', in_shop = false, weight = 0, extra_cost = 0, config = {},
    sound = {sound = 'generic1', per = 1, vol = 0.3},
    loc_txt = {name = "Lunar (Legacy)", text = {"Old version", "Will update next round"}}
})

SMODS.Edition({
    key = 'odyssey_lunar_red', shader = 'lunar_red', in_shop = false, weight = 0, extra_cost = 0, config = {},
    sound = {sound = 'generic1', per = 1, vol = 0.3},
    loc_txt = {name = "Lunar (Legacy)", text = {"Old version", "Will update next round"}}
})

print("DEBUG: Lunar Editions registered (16 evolutions + eclipse + legacy keys)")
